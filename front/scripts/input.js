...
$(document).ready(function() {
    ...
    document.getElementById("showType").checked = inputSettings.showType;
    ...
    $('input[type="checkbox"]').click(function(){
        ...
        if (box == "kana") {
            setVisibility();
        } else if (box == "showType") {
            setVisibility();
            inputSettings.showType = checked;
